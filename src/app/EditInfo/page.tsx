...
export default function EditInfo() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, padding: 16, width: '100%', boxSizing: 'border-box', minHeight: '100%', justifyContent: 'center' }}> {/* style: **content-box** -> **border-box**, reason: on a phone the page was 32px wider than the screen and the underlines ran off the right edge, mechanism: width 100% now includes the 16px padding on each side instead of adding to it */} {/* style: **top-aligned** -> **minHeight 100% + justifyContent center**, mechanism: the column now stretches to the full screen height (html/body are height 100% in globals.css, or MobileView's phone box) and the form sits in its vertical middle, same as in MobileTester */}
